...
| `lilypond_selectable_text.pdf` | [C] | Frozen 57,106-byte LilyPond score PDF produced by the MTDT Clare's Dragoons preflight; exact source SHA-256 `45f761953b230720aea5a686d6504a5547ae46d6c40e97248347d54d1292bd68` | Never regenerate silently; its provider test freezes Type1C codes, glyph names, Unicode loss ledger, text positions, page identity, and aggregate counts |
